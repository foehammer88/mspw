...
class AnalyticsControllerTest < ActionController::TestCase
  ...
  test "should create analytic" do
    assert_difference('Analytic.count') do
      post :create, analytic: { amount_money: @analytic.amount_money, amount_student_used: @analytic.amount_student_used, college: @analytic.college, total_on_campus: @analytic.total_on_campus, year: @analytic.year }
    end
  ...
  test "should update analytic" do
    put :update, id: @analytic, analytic: { amount_money: @analytic.amount_money, amount_student_used: @analytic.amount_student_used, college: @analytic.college, total_on_campus: @analytic.total_on_campus, year: @analytic.year }
    assert_redirected_to analytic_path(assigns(:analytic))
  end
